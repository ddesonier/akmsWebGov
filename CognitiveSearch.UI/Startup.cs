...
namespace CognitiveSearch.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.AddBlobServiceClient(Configuration["blob-connect:blob"], preferMsi: true);
                builder.AddQueueServiceClient(Configuration["blob-connect:queue"], preferMsi: true);
            });
